...
function Navbar() {
  return (
        ...
        <div className='relative top-[0px] left-[0px] bg-black w-72 h-[1024px] overflow-hidden text-base text-lightgray font-poppins z-1'>
            ...
            <Link to='/dashboard' className="absolute top-[132px] left-[30px] font-medium cursor-pointer no-underline text-white">Dashboard</Link>
            <Link to='/menu' className="absolute top-[183px] left-[30px] font-medium cursor-pointer no-underline text-white">Menu</Link>
            <Link to='/inventory' className="absolute top-[234px] left-[30px] font-medium cursor-pointer no-underline text-white">Inventory</Link>
            <Link to='/saleshistory' className="absolute top-[285px] left-[30px] font-medium cursor-pointer no-underline text-white">Sales History</Link>
            <img
                className="absolute top-[343px] left-[20px] w-[247.5px] h-0.5"
                alt=""
                src={Vector4}
                />
            <Link to='/settings' className="absolute top-[366px] left-[30px] font-medium cursor-pointer no-underline text-white">Settings</Link>
